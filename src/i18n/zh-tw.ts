import AppZhTW from '@main/shared/i18n/zh-tw.js'
...
const zhTW: LANG_MESSAGE = {
  ...
  subtitle: '代理管理',
  profiles: '配置',
  downloadProfile: '下載配置',
  importProfile: '匯入配置',
  importFromLocalFile: '從本地檔案匯入',
  subscriptionURL: '訂閱地址',
  coreStatus: '核心狀態',
  autoLaunch: '自動啟動',
  ...
  addProfile: '新增配置',
  editProfile: '編輯配置',
  createEmptyProfile: '建立空白配置',
  profileName: '配置名稱',
  create: '建立',
  systemProxy: '系統代理',
  profileUpdated: '配置更新成功',
  profileUpdateFailed: '配置更新失敗',
  updateInterval: '更新間隔',
  autoUpdate: '自動更新',
  deleteProfile: '刪除配置',
  deleteProfileConfirm: '確定要刪除配置 "{name}" 嗎？此操作不可撤銷。',
  runtimeConfig: '運行時配置',
  clearRuntimeDir: '清空運行時目錄',
  updateCore: '更新內核',
  updateCoreDescription: '選擇如何更新內核二進制檔案。您可以從官方倉庫下載或手動上傳檔案。',
  updateFromOfficial: '從官方更新',
  updateFromFile: '從檔案更新',
  preparingDownload: '準備下載…',
  downloadingCore: '下載內核中',
  installingCore: '安裝內核中…',
  checkFailed: 'JSON格式檢查失敗，請檢查配置檔案 {error}',
  unsaved: '未儲存',
  config: '配置',
